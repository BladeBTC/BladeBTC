...
class MailGroupMemberModel
{
	...
	public static function getAllMembersFromGroupID($group_id, $fetch_mode = PDO::FETCH_OBJ)
	{
		...
		$members = $db->query("SELECT * FROM ae_mail_group_member WHERE mail_group_id = $group_id")->fetchAll($fetch_mode);
	...
	public static function delete($id)
	{
		...
		Database::transaction($db, [
			"DELETE FROM ae_mail_group_member WHERE id = $id",
		]);
	}
}
